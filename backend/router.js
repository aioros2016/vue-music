...
// 注册推荐列表接口路由
function registerRecommend(req, res) {
  // 第三方服务接口 url
...
// 注册歌手列表接口路由
function registerSingerList(req, res) {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
  const HOT_NAME = '热'
...
// 注册歌手详情接口路由
function registerSingerDetail(req, res) {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
...
function registerSongsUrl(req, res) {
...
// 注册歌词接口
function registerLyric(req, res) {
...
// 注册歌单专辑接口
function registerAlbum(req, res) {
  const data = {
    req_0: {
...
// 注册排行榜接口
function registerTopList(req, res) {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
...
// 注册排行榜详情接口
function registerTopDetail(req, res) {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
...
// 注册热门搜索接口
function registerHotKeys(req, res) {
...
// 注册搜索查询接口
function registerSearch(req, res) {
...
// 注册后端路由
router
    .get('/api/getRecommend', registerRecommend)
    .get('/api/getSingerList', registerSingerList)
    .get('/api/getSingerDetail', registerSingerDetail)
    .get('/api/getSongsUrl', registerSongsUrl)
    .get('/api/getLyric', registerLyric)
    .get('/api/getAlbum', registerAlbum)
    .get('/api/getTopList', registerTopList)
    .get('/api/getTopDetail', registerTopDetail)
    .get('/api/getHotKeys', registerHotKeys)
    .get('/api/search', registerSearch)
